      ...
      >
        ...
        {!loading && filtered.length === 0 && (
          <View className="items-center pt-16">
            ...
            <Text className="mt-3 text-gray-400 dark:text-zinc-500 text-sm">Aucun dossier en attente</Text>
          </View>
        )}

        {filtered.map(prescriber => (
          <View key={prescriber.id} className="bg-white dark:bg-zinc-900 rounded-2xl p-4 mb-3 shadow-sm">
            <View className="flex-row items-center mb-3">
              <View style={{ width: 42, height: 42, borderRadius: 21, backgroundColor: joyful.primaryMuted, alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
            ...
            <View className="flex-row gap-4 mb-3 px-1">
              <View className="items-center">
                ...
                <Text className="text-[12px] font-bold text-gray-800 dark:text-zinc-200 mt-1">{prescriber.documentsCount}</Text>
